...
async def auto_link_gen(client: Client, message: ConvoMessage) -> Optional[Message]:
    """Handle files that are sent or forwarded directly to the bot and generate a link for them."""
